...
import com.quickCodes.quickCodes.adapters.UssdCodesAdapter;
...
public class UssdCodesFragment extends Fragment {

    private static final String TAG = "UssdCodesFragment";
    ...
    private UssdCodesAdapter recentAdapter;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recentAdapter = new UssdCodesAdapter(this);
    }

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {

        View root = inflater.inflate(R.layout.fragment_ussdcodes, container, false);
...
//        viewPagerSimcards.beginFakeDrag();
        ...
        new TabLayoutMediator(tabLayout, tabsPager,
                (tab, position) -> {
                    if (position == 0) tab.setText("Airtime");
                    if (position == 1) tab.setText("Data");
                    if (position == 2) tab.setText("Mobile money");
                    if (position == 3) tab.setText("Custom codes");
                    if (position == 4) tab.setText("Auto saved");
